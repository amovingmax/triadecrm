...
insert into public.sources (slug, name, kind, base_url, legal_basis, terms_notes, robots_ok, rate_limit_seconds, is_enabled, config) values
  ...
  ('base_cnpj', 'Base de CNPJ — Receita Federal (dados abertos)', 'import', 'https://arquivos.receitafederal.gov.br/dados/cnpj/dados_abertos_cnpj/', 'legitimo_interesse',
  ...
  ('google_places', 'Google Places API (New)', 'api', 'https://places.googleapis.com/v1/', 'legitimo_interesse',
