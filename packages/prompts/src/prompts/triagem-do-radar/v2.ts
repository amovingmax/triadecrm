...
/**
 * `triagem-do-radar@v2` — Claude Haiku 4.5, saída estruturada.
 *
 * ===========================================================================
 * O QUE MUDOU DA v1, E POR QUE ISSO É UMA VERSÃO E NÃO UM AJUSTE
 * ===========================================================================
 * A v1 já devolvia `categoriaSugerida` — e o CRM jogava fora, porque
 * `public.ia_gravar_triagem` não a gravava. Quando a coluna passou a existir
 * (migração 20261001150000), o ÚNICO exemplo do prompt virou um problema: ele
 * ensinava a resposta errada.
 *
 * As saídas de exemplo da v1 devolviam `categoriaSugerida: 'Locais'` e
 * `'Alimentos e Bebidas'`. São nomes de GRUPO, não de categoria — as reais são
 * "Locais: salões, chácaras, hotéis, restaurantes, praia" e "Buffet
 * adulto/corporativo" (`supabase/seed.sql`). E a regra de gravação é casar
 * EXATO por `app.chave_catalogo`: com aquele exemplo, o modelo era treinado a
 * produzir string que nunca casa. Exemplo vale mais que instrução, então isto é
 * v2 com eval, e não um remendo na v1.
 *
 * A segunda mudança: `categoriaDaFonte` deixou de chegar nula. A v1 tinha um
 * comentário dizendo que o modelo só precisa do nome — era verdade enquanto a
 * única pergunta era "isto é fornecedor de evento?". Para a categoria, o rótulo
 * da fonte é metade da pergunta: "Loja de Presentes" junto de "PICMIMOS —
 * Revelação de Fotos" é uma leitura diferente de cada um deles sozinho.
 *
 * ===========================================================================
...
export type EntradaDaTriagemV2 = z.infer<typeof entrada>;
...
export type SaidaDaTriagemV2 = z.infer<typeof saida>;
...
- "categoriaSugerida" só pode ser uma das categorias da lista CATEGORIAS DO CATÁLOGO, copiada LETRA POR LETRA, inteira, com a pontuação que ela tem. "Locais" não serve se a categoria é "Locais: salões, chácaras, hotéis, restaurantes, praia". Se nenhuma serve, responda nulo — nulo é melhor que aproximado, porque o que não casa exato é descartado de qualquer jeito.
- O rótulo que a fonte deu é uma PISTA, e não a verdade: o Google chama de "Loja de Presentes" uma empresa que revela fotos. Quando o nome e o rótulo discordarem, vale o nome.
- Em "incerto", "confianca" nunca passa de 0,6.
- Você não aprova nem recusa ninguém: alguém vai ler o seu veredito e decidir.`;

export const triagemDoRadarV2 = definirPrompt<EntradaDaTriagemV2, SaidaDaTriagemV2>({
  id: 'triagem-do-radar',
  versao: 2,
        ...
        candidatos: [
          {
            ...
            categoriaDaFonte: 'Fotógrafo',
            categoriaDoCrm: 'Fotografia e vídeo',
            cidade: 'Natal',
            bairro: 'Tirol',
          },
          {
            ...
            categoriaDaFonte: 'Salão de festas',
            categoriaDoCrm: 'Locais: salões, chácaras, hotéis, restaurantes, praia',
            cidade: 'Parnamirim',
            bairro: null,
          },
          {
          ...
          {
            // O caso que o de-para não resolve e o nome resolve: o rótulo do
            // Google é varejo, e a empresa revela foto.
            id: '4',
            nome: 'PICMIMOS — Revelação de Fotos e Álbuns',
            categoriaDaFonte: 'Loja de Presentes',
            categoriaDoCrm: null,
            cidade: 'Natal',
            bairro: 'Lagoa Nova',
          },
      ...
      saida: {
        vereditos: [
          ...
          },
          {
            ...
            // A categoria INTEIRA, como está no catálogo. "Locais" sozinho não
            // casa com nada, e o que não casa é descartado.
            categoriaSugerida: 'Locais: salões, chácaras, hotéis, restaurantes, praia',
            confianca: 0.9,
          },
          {
            id: '3',
            ...
            // Incerto com categoria nula: adivinhar aqui seria pôr uma padaria
            // no funil de buffet, e o funil decide o pitch.
            categoriaSugerida: null,
            confianca: 0.5,
          },
          {
            id: '4',
            veredito: 'sim',
            porque: '"Revelação de Fotos e Álbuns" no nome; o rótulo de varejo é do Google.',
