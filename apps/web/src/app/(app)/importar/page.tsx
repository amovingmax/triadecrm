...
import { podeDesfazerLote } from '@/components/importacao/tipos';
 ...
 * conjuntos de papéis diferentes, §3.7 do laudo) e resolve o id da fonte
 * "planilha", que é o `source_id` do lote em `import_batches`. Ler o arquivo,
 * conferir a prévia e gravar acontece no cliente, contra as funções do Postgres.
 */
